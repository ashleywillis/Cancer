...
placentacancer1 %>%
  ...
  ggtitle("Neoplasia Prevalence by Degree of Placentation")+
  xlab("Placental Invasion")+
  ylab("Neoplasia %")


# Interdigitation x malignancy prevalence
placentacancer1$interdigitation_placenta <- factor(placentacancer1$interdigitation_placenta,levels = c("Trabecular", "Villous", "Labyrinthine"))


placentacancer1 %>%
  ggplot(.)+
  geom_boxplot(aes(x= interdigitation_placenta, y= prev.mal))+
  ggtitle("Malignancy Prevalence by Fibroblast Interdigitation")+
...
placentacancer1 %>%
  ...
  ggtitle("Rate of Malignant Transformation by Degree of Placentation")+
  xlab("Placental Invasion")+
...
placentacancer1 %>%
  ...
  ggtitle("Rate of Malignant Transformation by Fibroblast Interdigitation")+
  xlab("Interdigitation Class")+
  ylab("Rate of Malignant Transformation")
...
mammallist$invade <- as.character(mammallist$invade)
mammallist$mal.trans <- as.numeric(mammallist$mal.trans)

mammallist %>%
  ggplot(aes(x=invade, y=mal.trans))+
  geom_boxplot()
```