...
phylogeny <- read.newick("mammals_species.nwk")
plot(phylogeny)

phylo <- read.newick("species1.nwk")
...
malig <- placentacancer2 [, "mal.trans"]
interdig <- placentacancer2 [, "digit"]

names(malig) <- names(interdig) <- rownames(placentacancer2)

mPic <- pic(malig, tree)

name.check(tree, placentacancer2)
